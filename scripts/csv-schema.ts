  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        type: "string",
        title: "Ironing notes",
        description: "Prose: how to iron it, or why you don't. Often empty.",
      },
      {
        name: "iron_setting",
        type: "string",
        title: "Iron thermostat",
        description: "Where the iron's thermostat points. Empty when ironing is no.",
        constraints: { enum: ironSettingKeys(machine) },
      },
      {
        name: "drying",
        type: "string",
