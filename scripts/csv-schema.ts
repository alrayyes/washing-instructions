 ...
 *
 * Generated rather than written by hand, because `src/machine.ts` is the
 ...
 */
import { ironSettingKeys, washer } from "../src/machine";
  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        constraints: { required: true, enum: [...ironSettingKeys, "none"] },
      },
      {
        name: "drying",
        type: "string",
...
if (import.meta.main) {
  await Bun.write(SCHEMA_PATH, `${JSON.stringify(tableSchema(), null, 2)}\n`);
