...
/** The pair the README links, regenerated by `bun run examples`. */
const EXAMPLES = ["washing-instructions-phone.pdf", "washing-instructions-print.pdf"];
...
describe("bun run generate", () => {
  ...
  /**
   * The README links the two PDFs under docs/ rather than describing them, so
